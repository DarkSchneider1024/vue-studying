...
</div>`,hints:[`export 具名匯出在引用時必須加上花括號 import { name }。`,`現代打包器 Vite 便是原生利用瀏覽器的 ES Modules 特性實現秒級熱更新。`]}],Aw=[{id:`project-overview-setup`,category:`專案導讀與概念篇`,title:`00. Vue 專案全局導讀：架構、安裝與學習地圖`,summary:`在寫下第一行代碼前，先搞懂為什麼要學 Vue？專案裡面有哪些檔案？以及如何用 npm 安裝並啟動專案！`,readTime:`6 分鐘`,concept:`
...
<\/script>`,hints:[`將顏色抽離為 CSS Tokens，不同客戶或深淺色模式再也不需要重複寫 5 份 CSS。`]},{id:`mobile-first-rwd`,category:`架構實戰篇`,title:`23. 行動端適配與 RWD 實戰：Vue 3 組件化響應式架構`,summary:`搞懂 SPA 時代的響應式設計！學習 CSS 媒體查詢 vs Vue 響應式 Composable、全螢幕 Teleport 浮層、iOS 安全區與手機避免水平滑動的元件降級秘笈。`,readTime:`10 分鐘`,concept:`
...
<\/script>`,hints:[`熟記四階段進程（Phase 0~4）與三不原則（不動後端、不中斷線上營運、不盲目重寫），提案必勝！`]}],jw=[{id:`css`,label:`CSS`,title:`CSS 樣式與排版`,count:Ow.length,badgeText:`${Ow.length} 單元`,description:`選擇器權重、盒模型、Flexbox/Grid、RWD 與 CSS 變數`,curriculum:Ow},{id:`html`,label:`HTML`,title:`HTML 結構與語意`,count:Dw.length,badgeText:`${Dw.length} 單元`,description:`標準骨架、DOM 樹、語意化標籤、現代表單與報表表格`,curriculum:Dw},{id:`javascript`,label:`Javascript`,title:`JavaScript 邏輯與引擎`,count:kw.length,badgeText:`${kw.length} 單元`,description:`ES6+ 宣告、解構展開、箭頭函式、陣列方法、Promise/async、ESM`,curriculum:kw},{id:`vue`,label:`Vue`,title:`Vue 3 實戰與架構遷移`,count:Aw.length,badgeText:`${Aw.length} 單元`,description:`Composition API、狀態驅動、組件化、Pinia、路由與企業架構重構`,curriculum:Aw}];[...Aw,...Dw,...Ow,...kw];function Mw(e){let t=jw.find(t=>t.id===e);return t?t.curriculum:Aw}function Nw(e){return e.startsWith(`html-`)?`html`:e.startsWith(`css-`)?`css`:e.startsWith(`js-`)?`javascript`:`vue`}function Pw(){return typeof window<`u`&&typeof window.gtag==`function`}function Fw(e,t){if(Pw())try{let n=t.startsWith(`/`)?t:`/${t}`;window.gtag(`event`,`page_view`,{page_title:e,page_location:window.location.href,page_path:n})}catch(e){console.debug(`[GA] trackPageView error:`,e)}}function Iw(e,t){if(Pw())try{window.gtag(`event`,`lesson_complete`,{track_name:e,lesson_id:t})}catch(e){console.debug(`[GA] trackLessonComplete error:`,e)}}var Lw=`網頁製作教學網站`,Rw=`https://darkschneider1024.github.io/vue-studying/`;function zw(e,t,n){let r=document.querySelector(`meta[${e}="${t}"]`);r||(r=document.createElement(`meta`),r.setAttribute(e,t),document.head.appendChild(r)),r.setAttribute(`content`,n)}function Bw(e){let t=document.querySelector(`link[rel="canonical"]`);t||(t=document.createElement(`link`),t.setAttribute(`rel`,`canonical`),document.head.appendChild(t)),t.setAttribute(`href`,e)}function Vw({title:e,description:t,keywords:n,hashPath:r}){if(typeof document>`u`)return;let i=e?`${e} | ${Lw}`:`${Lw} - 全方位實戰自學指南`,a=t||`網頁製作教學網站：涵蓋 HTML5、CSS3、JavaScript (ES6+)、Vue 3 與現代化全端架構，MDN 風格即打即測！`,o=r?`${Rw}${r}`:Rw;document.title=i,zw(`name`,`description`,a),n&&zw(`name`,`keywords`,n),zw(`property`,`og:title`,i),zw(`property`,`og:description`,a),zw(`property`,`og:url`,o),zw(`property`,`og:site_name`,Lw),zw(`name`,`twitter:title`,i),zw(`name`,`twitter:description`,a),Bw(o)}var Hw={class:`app-layout`},Uw={key:0,class:`welcome-wrapper`},Ww={key:1,class:`glossary-wrapper`},Gw={key:2,class:`main-workspace`},Kw={class:`workspace-main-area`},qw={key:0,class:`mobile-subnav-tabs`},Jw={class:`workspace-split`},Yw={class:`doc-viewport`},Xw={class:`doc-inner-container`},Zw={key:0,class:`mobile-quick-jump`},Qw={class:`playground-viewport`},$w={class:`playground-inner-container`},eT={class:`playground-banner`},tT={class:`banner-title-wrap`};Ko(cx({__name:`App`,setup(e){let t=j(`welcome`),n=(e=!1)=>{let n=`#/welcome`,r=`歡迎首頁`,i=`網頁製作教學網站：涵蓋 HTML5、CSS3、JavaScript (ES6+)、Vue 3 與現代化全端架構，MDN 風格即打即測！`,a=`網頁製作, 網頁製作教學, 前端, HTML, CSS, JavaScript, Vue3, 自學, 程式教學`,o=`/welcome`;if(t.value===`glossary`)n=`#/glossary`,r=`前端必懂名詞速查字典`,i=`前端工程師必備字典：DOM、SFC、Reactivity、Hydration、Vite 等關鍵概念解析。`,o=`/glossary`;else if(t.value===`lessons`){let e=g.value;e&&(n=`#/${s.value}/${e.id}`,r=e.title,i=e.summary||i,a=`${s.value}, ${e.title}, 網頁製作教學, 實戰練習`,o=`/${s.value}/${e.id}`)}typeof window<`u`&&window.location.hash!==n&&(e?history.replaceState(null,``,n):history.pushState(null,``,n)),Vw({title:r,description:i,keywords:a,hashPath:n}),Fw(`${r} - 網頁製作教學網站`,o)},r=e=>{if(t.value=e,localStorage.setItem(`program-study-last-view`,e),n(!1),e===`welcome`){let e=document.querySelector(`.welcome-wrapper`);e&&e.scrollTo({top:0,behavior:`smooth`})}},i=j(`doc`),a=j(typeof window<`u`?window.innerWidth>960:!0),o=()=>{a.value=window.innerWidth>960,window.innerWidth<=1024&&(d.value=!1)},s=j(`vue`),c=z(()=>Mw(s.value)),l=j(!1),u=()=>{l.value=!l.value,l.value?(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`vue-study-theme`,`dark`)):(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`vue-study-theme`,`light`))},d=j(!0),f=()=>{d.value=!d.value},p=()=>{window.innerWidth<=1024&&(d.value=!1)},m=j(`project-overview-setup`),h=z(()=>{let e=c.value.findIndex(e=>e.id===m.value);return e>=0?e:0}),g=z(()=>c.value[h.value]||c.value[0]),_=z(()=>h.value>0),v=z(()=>h.value<c.value.length-1),y=()=>{if(typeof window>`u`)return;let e=window.location.hash||``;if(e===`#/welcome`||e===`#/`||!e){if(!e){let e=localStorage.getItem(`program-study-last-view`);if(e===`glossary`){t.value=`glossary`,n(!0);return}if(e===`lessons`){t.value=`lessons`,n(!0);return}}t.value=`welcome`,n(!0);return}if(e===`#/glossary`){t.value=`glossary`,n(!0);return}let r=e.replace(/^#\/?/,``).split(`/`),i=r[0],a=r[1];if(jw.some(e=>e.id===i)){s.value=i,localStorage.setItem(`program-study-last-track`,i),t.value=`lessons`;let e=Mw(i);a&&e.some(e=>e.id===a)?m.value=a:e.length>0&&(m.value=e[0].id),localStorage.setItem(`program-study-last-lesson-${i}`,m.value),n(!0);return}t.value=`welcome`,n(!0)},b=e=>{s.value=e,localStorage.setItem(`program-study-last-track`,e),t.value!==`lessons`&&(t.value=`lessons`,localStorage.setItem(`program-study-last-view`,`lessons`));let r=Mw(e),i=localStorage.getItem(`program-study-last-lesson-${e}`);i&&r.some(e=>e.id===i)?m.value=i:r.length>0&&(m.value=r[0].id),n(!1),C(),p()},x=e=>{b(e),t.value=`lessons`,n(!1)},ee=({track:e,lessonId:r})=>{e&&e!==s.value&&(s.value=e,localStorage.setItem(`program-study-last-track`,e)),t.value=`lessons`;let i=Mw(s.value);r&&i.some(e=>e.id===r)?m.value=r:i.length>0&&(m.value=i[0].id),localStorage.setItem(`program-study-last-lesson-${s.value}`,m.value),n(!1),C(),p()},S=e=>{let r=Nw(e);r!==s.value&&(s.value=r,localStorage.setItem(`program-study-last-track`,r)),t.value=`lessons`,m.value=e,localStorage.setItem(`program-study-last-lesson-${s.value}`,e),localStorage.setItem(`vue-study-last-lesson`,e),p(),C(),n(!1),a.value||(i.value=`doc`)},C=()=>{let e=document.querySelector(`.doc-viewport`);e&&e.scrollTo({top:0,behavior:`smooth`})},te=()=>{_.value&&S(c.value[h.value-1].id)},ne=()=>{v.value&&S(c.value[h.value+1].id)},w=j([]),T=e=>{let t=w.value.indexOf(e);t>-1?w.value.splice(t,1):(w.value.push(e),Iw(s.value,e)),localStorage.setItem(`vue-study-completed`,JSON.stringify(w.value))},re=z(()=>c.value.filter(e=>w.value.includes(e.id)).length),ie=z(()=>c.value.length);return xr(()=>{window.addEventListener(`resize`,o),o();let e=localStorage.getItem(`vue-study-theme`);(e===`dark`||!e&&window.matchMedia(`(prefers-color-scheme: dark)`).matches)&&(l.value=!0,document.documentElement.setAttribute(`data-theme`,`dark`));let n=localStorage.getItem(`program-study-last-view`);n&&[`lessons`,`glossary`,`welcome`].includes(n)&&(t.value=n);let r=localStorage.getItem(`program-study-last-track`);r&&jw.some(e=>e.id===r)&&(s.value=r);let i=Mw(s.value),a=localStorage.getItem(`program-study-last-lesson-${s.value}`)||localStorage.getItem(`vue-study-last-lesson`);a&&i.some(e=>e.id===a)?m.value=a:i.length>0&&(m.value=i[0].id);let c=localStorage.getItem(`vue-study-completed`);if(c)try{w.value=JSON.parse(c)}catch{w.value=[]}sx(),window.addEventListener(`popstate`,y),y()}),Tr(()=>{window.removeEventListener(`resize`,o),window.removeEventListener(`popstate`,y)}),(e,n)=>(P(),F(`div`,Hw,[L(Fx,{"is-dark":l.value,"sidebar-open":d.value,"current-view":t.value,"current-track":s.value,tracks:M(jw),"track-completed-count":re.value,"track-total-lessons":ie.value,onToggleTheme:u,onToggleSidebar:f,onToggleView:r,onSelectTrack:b},null,8,[`is-dark`,`sidebar-open`,`current-view`,`current-track`,`tracks`,`track-completed-count`,`track-total-lessons`]),t.value===`welcome`?(P(),F(`div`,Uw,[L(Ew,{onStartTrack:x,onOpenLessons:n[0]||=e=>t.value=`lessons`})])):t.value===`glossary`?(P(),F(`div`,Ww,[L(TC,{onClose:n[1]||=e=>t.value=`lessons`})])):(P(),F(`div`,Gw,[L(tS,{curriculum:c.value,"current-lesson-id":m.value,"completed-ids":w.value,"is-open":d.value,"current-track":s.value,tracks:M(jw),onSelectLesson:S,onToggleComplete:T,onCloseSidebar:p,onSelectTrack:b},null,8,[`curriculum`,`current-lesson-id`,`completed-ids`,`is-open`,`current-track`,`tracks`]),I(`div`,Kw,[a.value?R(``,!0):(P(),F(`div`,qw,[I(`button`,{class:E([`mobile-subnav-btn`,{"is-active":i.value===`doc`}]),onClick:n[2]||=e=>i.value=`doc`},[L(M(as),{size:15}),n[5]||=I(`span`,null,`課程教學文檔`,-1)],2),I(`button`,{class:E([`mobile-subnav-btn`,{"is-active":i.value===`playground`}]),onClick:n[3]||=e=>i.value=`playground`},[L(M(gs),{size:15}),n[6]||=I(`span`,null,`即時互動演練台`,-1)],2)])),I(`div`,Jw,[Nn(I(`div`,Yw,[I(`div`,Xw,[L(xS,{lesson:g.value,"is-completed":w.value.includes(g.value.id),"has-prev":_.value,"has-next":v.value,onPrevLesson:te,onNextLesson:ne,onToggleComplete:T,onJumpTrack:ee},null,8,[`lesson`,`is-completed`,`has-prev`,`has-next`]),a.value?R(``,!0):(P(),F(`div`,Zw,[I(`button`,{class:`quick-jump-btn`,onClick:n[4]||=e=>i.value=`playground`},[L(M(gs),{size:16}),n[7]||=I(`span`,null,`動手打代碼：切換至即時演練台 →`,-1)])]))])],512),[[$a,a.value||i.value===`doc`]]),Nn(I(`div`,Qw,[I(`div`,$w,[I(`div`,eT,[I(`div`,tT,[L(M(gs),{size:18,class:`banner-icon`}),n[8]||=I(`span`,{class:`banner-title`},`即時互動演練台 (Live Playground)`,-1)]),n[9]||=I(`span`,{class:`banner-subtext`},`邊看教學，邊在下方動手打代碼！`,-1)]),L(QS,{"starter-code":g.value.starterCode,"solution-code":g.value.solutionCode,"lesson-id":g.value.id},null,8,[`starter-code`,`solution-code`,`lesson-id`])])],512),[[$a,a.value||i.value===`playground`]])])])]))]))}},[[`__scopeId`,`data-v-c593d738`]])).mount(`#app`);