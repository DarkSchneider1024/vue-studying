...
<\/script>`,hints:[`熟記四階段進程（Phase 0~4）與三不原則（不動後端、不中斷線上營運、不盲目重寫），提案必勝！`]}],ww=[{id:`css`,label:`CSS`,title:`CSS 樣式與排版`,count:xw.length,badgeText:`${xw.length} 單元`,description:`選擇器權重、盒模型、Flexbox/Grid、RWD 與 CSS 變數`,curriculum:xw},{id:`html`,label:`HTML`,title:`HTML 結構與語意`,count:bw.length,badgeText:`${bw.length} 單元`,description:`標準骨架、DOM 樹、語意化標籤、現代表單與報表表格`,curriculum:bw},{id:`javascript`,label:`Javascript`,title:`JavaScript 邏輯與引擎`,count:Sw.length,badgeText:`${Sw.length} 單元`,description:`ES6+ 宣告、解構展開、箭頭函式、陣列方法、Promise/async、ESM`,curriculum:Sw},{id:`vue`,label:`Vue`,title:`Vue 3 實戰與架構遷移`,count:Cw.length,badgeText:`${Cw.length} 單元`,description:`Composition API、狀態驅動、組件化、Pinia、路由與企業架構重構`,curriculum:Cw}];[...Cw,...bw,...xw,...Sw];function Tw(e){let t=ww.find(t=>t.id===e);return t?t.curriculum:Cw}function Ew(e){return e.startsWith(`html-`)?`html`:e.startsWith(`css-`)?`css`:e.startsWith(`js-`)?`javascript`:`vue`}function Dw(){return typeof window<`u`&&typeof window.gtag==`function`}function Ow(e,t){if(Dw())try{let n=t.startsWith(`/`)?t:`/${t}`;window.gtag(`event`,`page_view`,{page_title:e,page_location:window.location.origin+window.location.pathname+`#`+n,page_path:n})}catch(e){console.debug(`[GA] trackPageView error:`,e)}}function kw(e,t,n){if(Dw())try{window.gtag(`event`,`select_content`,{content_type:`lesson`,item_id:t,track_name:e,item_name:n})}catch(e){console.debug(`[GA] trackLessonSelect error:`,e)}}function Aw(e,t){if(Dw())try{window.gtag(`event`,`lesson_complete`,{track_name:e,lesson_id:t})}catch(e){console.debug(`[GA] trackLessonComplete error:`,e)}}var jw={class:`app-layout`},Mw={key:0,class:`welcome-wrapper`},Nw={key:1,class:`glossary-wrapper`},Pw={key:2,class:`main-workspace`},Fw={class:`workspace-main-area`},Iw={key:0,class:`mobile-subnav-tabs`},Lw={class:`workspace-split`},Rw={class:`doc-viewport`},zw={class:`doc-inner-container`},Bw={key:0,class:`mobile-quick-jump`},Vw={class:`playground-viewport`},Hw={class:`playground-inner-container`},Uw={class:`playground-banner`},Ww={class:`banner-title-wrap`};qo(cx({__name:`App`,setup(e){let t=j(`welcome`),n=e=>{if(t.value=e,localStorage.setItem(`program-study-last-view`,e),Ow(`View: ${e} - Program Studying`,`/${e}`),e===`welcome`){let e=document.querySelector(`.welcome-wrapper`);e&&e.scrollTo({top:0,behavior:`smooth`})}},r=j(`doc`),i=j(typeof window<`u`?window.innerWidth>960:!0),a=()=>{i.value=window.innerWidth>960,window.innerWidth<=1024&&(u.value=!1)},o=j(`vue`),s=R(()=>Tw(o.value)),c=j(!1),l=()=>{c.value=!c.value,c.value?(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`vue-study-theme`,`dark`)):(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`vue-study-theme`,`light`))},u=j(!0),d=()=>{u.value=!u.value},f=()=>{window.innerWidth<=1024&&(u.value=!1)},p=j(`project-overview-setup`),m=R(()=>{let e=s.value.findIndex(e=>e.id===p.value);return e>=0?e:0}),h=R(()=>s.value[m.value]||s.value[0]),g=R(()=>m.value>0),_=R(()=>m.value<s.value.length-1),v=e=>{o.value=e,localStorage.setItem(`program-study-last-track`,e),t.value!==`lessons`&&(t.value=`lessons`,localStorage.setItem(`program-study-last-view`,`lessons`));let n=Tw(e),r=localStorage.getItem(`program-study-last-lesson-${e}`);r&&n.some(e=>e.id===r)?p.value=r:n.length>0&&(p.value=n[0].id),S(),f()},y=e=>{v(e),t.value=`lessons`},b=({track:e,lessonId:t})=>{e&&e!==o.value&&(o.value=e,localStorage.setItem(`program-study-last-track`,e));let n=Tw(o.value);t&&n.some(e=>e.id===t)?p.value=t:n.length>0&&(p.value=n[0].id),localStorage.setItem(`program-study-last-lesson-${o.value}`,p.value),S(),f()},x=e=>{let t=Ew(e);t!==o.value&&(o.value=t,localStorage.setItem(`program-study-last-track`,t)),p.value=e,localStorage.setItem(`program-study-last-lesson-${o.value}`,e),localStorage.setItem(`vue-study-last-lesson`,e),f(),S(),h.value&&(kw(o.value,e,h.value.title),Ow(`${h.value.title} - Program Studying`,`/${o.value}/${e}`)),i.value||(r.value=`doc`)},S=()=>{let e=document.querySelector(`.doc-viewport`);e&&e.scrollTo({top:0,behavior:`smooth`})},C=()=>{g.value&&x(s.value[m.value-1].id)},ee=()=>{_.value&&x(s.value[m.value+1].id)},w=j([]),te=e=>{let t=w.value.indexOf(e);t>-1?w.value.splice(t,1):(w.value.push(e),Aw(o.value,e)),localStorage.setItem(`vue-study-completed`,JSON.stringify(w.value))},ne=R(()=>s.value.filter(e=>w.value.includes(e.id)).length),T=R(()=>s.value.length);return xr(()=>{window.addEventListener(`resize`,a),a();let e=localStorage.getItem(`vue-study-theme`);(e===`dark`||!e&&window.matchMedia(`(prefers-color-scheme: dark)`).matches)&&(c.value=!0,document.documentElement.setAttribute(`data-theme`,`dark`));let n=localStorage.getItem(`program-study-last-view`);n&&[`lessons`,`glossary`,`welcome`].includes(n)&&(t.value=n);let r=localStorage.getItem(`program-study-last-track`);r&&ww.some(e=>e.id===r)&&(o.value=r);let i=Tw(o.value),s=localStorage.getItem(`program-study-last-lesson-${o.value}`)||localStorage.getItem(`vue-study-last-lesson`);s&&i.some(e=>e.id===s)?p.value=s:i.length>0&&(p.value=i[0].id);let l=localStorage.getItem(`vue-study-completed`);if(l)try{w.value=JSON.parse(l)}catch{w.value=[]}sx(),t.value===`welcome`?Ow(`歡迎首頁 - Program Studying`,`/welcome`):h.value&&Ow(`${h.value.title} - Program Studying`,`/${o.value}/${p.value}`)}),Tr(()=>{window.removeEventListener(`resize`,a)}),(e,a)=>(P(),F(`div`,jw,[L(Mx,{"is-dark":c.value,"sidebar-open":u.value,"current-view":t.value,"current-track":o.value,tracks:M(ww),"track-completed-count":ne.value,"track-total-lessons":T.value,onToggleTheme:l,onToggleSidebar:d,onToggleView:n,onSelectTrack:v},null,8,[`is-dark`,`sidebar-open`,`current-view`,`current-track`,`tracks`,`track-completed-count`,`track-total-lessons`]),t.value===`welcome`?(P(),F(`div`,Mw,[L(yw,{onStartTrack:y,onOpenLessons:a[0]||=e=>t.value=`lessons`})])):t.value===`glossary`?(P(),F(`div`,Nw,[L(vC,{onClose:a[1]||=e=>t.value=`lessons`})])):(P(),F(`div`,Pw,[L(Jx,{curriculum:s.value,"current-lesson-id":p.value,"completed-ids":w.value,"is-open":u.value,"current-track":o.value,tracks:M(ww),onSelectLesson:x,onToggleComplete:te,onCloseSidebar:f,onSelectTrack:v},null,8,[`curriculum`,`current-lesson-id`,`completed-ids`,`is-open`,`current-track`,`tracks`]),I(`div`,Fw,[i.value?ma(``,!0):(P(),F(`div`,Iw,[I(`button`,{class:E([`mobile-subnav-btn`,{"is-active":r.value===`doc`}]),onClick:a[2]||=e=>r.value=`doc`},[L(M(os),{size:15}),a[5]||=I(`span`,null,`課程教學文檔`,-1)],2),I(`button`,{class:E([`mobile-subnav-btn`,{"is-active":r.value===`playground`}]),onClick:a[3]||=e=>r.value=`playground`},[L(M(_s),{size:15}),a[6]||=I(`span`,null,`即時互動演練台`,-1)],2)])),I(`div`,Lw,[Nn(I(`div`,Rw,[I(`div`,zw,[L(mS,{lesson:h.value,"is-completed":w.value.includes(h.value.id),"has-prev":g.value,"has-next":_.value,onPrevLesson:C,onNextLesson:ee,onToggleComplete:te,onJumpTrack:b},null,8,[`lesson`,`is-completed`,`has-prev`,`has-next`]),i.value?ma(``,!0):(P(),F(`div`,Bw,[I(`button`,{class:`quick-jump-btn`,onClick:a[4]||=e=>r.value=`playground`},[L(M(_s),{size:16}),a[7]||=I(`span`,null,`動手打代碼：切換至即時演練台 →`,-1)])]))])],512),[[eo,i.value||r.value===`doc`]]),Nn(I(`div`,Vw,[I(`div`,Hw,[I(`div`,Uw,[I(`div`,Ww,[L(M(_s),{size:18,class:`banner-icon`}),a[8]||=I(`span`,{class:`banner-title`},`即時互動演練台 (Live Playground)`,-1)]),a[9]||=I(`span`,{class:`banner-subtext`},`邊看教學，邊在下方動手打代碼！`,-1)]),L(GS,{"starter-code":h.value.starterCode,"solution-code":h.value.solutionCode,"lesson-id":h.value.id},null,8,[`starter-code`,`solution-code`,`lesson-id`])])],512),[[eo,i.value||r.value===`playground`]])])])]))]))}},[[`__scopeId`,`data-v-57f4a745`]])).mount(`#app`);